      ...
      <div className="max-w-6xl mx-auto px-8 py-24 relative">
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-16">
          <div className="ml-12">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-4xl font-black font-display tracking-tight leading-none mb-2 text-white">Interview <span className="text-blue-500">History</span></h1>
                <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Review your past performance</p>
              </div>
            </div>
          </div>
          <div className="relative w-full md:w-80 group">
            ...
            <input 
              ...
              className="w-full pl-12 pr-6 py-4 bg-white/[0.02] border border-white/10 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-600/50 transition-all font-medium placeholder:text-slate-700 text-white"
            />
          </div>
        </header>
        ...
        {isLoading ? (
          ...
          <motion.div 
            ...
            className="text-center py-32 glass-card relative overflow-hidden group"
          >
            ...
            <HistoryIcon className="w-20 h-20 text-slate-800 mx-auto mb-8" />
            <h3 className="text-2xl font-black font-display mb-3 text-white">No sessions found</h3>
            <p className="text-slate-500 font-medium mb-10 max-w-sm mx-auto">You haven't completed any interviews yet. Start your journey today.</p>
            <Link to="/setup" className="btn-primary inline-flex items-center gap-3 px-10 py-5">
          ...
          <div className="grid gap-6">
            {filteredHistory.map((session, i) => (
              <motion.div 
                ...
                className="p-8 glass-card hover:bg-white/[0.06] transition-all group flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden"
              >
                ...
                <div className="flex items-center gap-8 relative z-10 w-full md:w-auto">
                  <div className="w-20 h-20 bg-blue-600/10 rounded-3xl flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-500 border border-blue-600/20">
                    <Award className="w-10 h-10 text-blue-400" />
                  </div>
                  <div>
                    <h3 className="text-2xl font-black font-display tracking-tight mb-2 text-white">{session.role}</h3>
                ...
                <div className="flex items-center gap-4 relative z-10 w-full md:w-auto justify-end">
                  <button 
                    ...
                    className="p-4 text-slate-600 hover:text-red-500 hover:bg-red-500/10 rounded-2xl transition-all active:scale-90"
                  ...
                  <button 
                    ...
                    className="flex items-center gap-3 px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl font-black uppercase tracking-widest text-xs transition-all active:scale-95 text-white"
                  >
                    View Report
